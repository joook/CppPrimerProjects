...
StrVec::StrVec(StrVec &&OriStrVec) noexcept
{
    ...
    m_Last = OriStrVec.m_Last;

    OriStrVec.m_First = nullptr;
    OriStrVec.m_FirstFree = nullptr;
    OriStrVec.m_Last = nullptr;

    cout << "StrVec moved." << endl;
}
...
StrVec &StrVec::operator=(const StrVec &OriStrVec)
{
    ...
    cout << "StrVec assigned a value." << endl;
...
StrVec &StrVec::operator=(StrVec &&OriStrVec) noexcept
{
    ...
    cout << "StrVec move-assigned a value." << endl;
...
void StrVec::freeMemory()
{
    if(m_First != nullptr)
    {
        ...
        */
        for_each(m_First, m_FirstFree
        , [](string &Str){ m_Allocator.destroy(&Str); });
